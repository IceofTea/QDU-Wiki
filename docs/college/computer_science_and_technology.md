...
!!! quote "备注"
    本页由 [@炎黄YH](https://github.com/IceofTea) 贡献。
...
| 专业 | 说明 |
| --- | --- |
| **计算机科学与技术** | 学院核心专业，覆盖计算机基础理论、软件与系统开发等方向，软硬件兼施的C.S大佬 |
| **计算机科学与技术(图灵班)** | 最初图灵班是入学后再选拔，如今是分高者得，一直是倾斜更加优质的师资力量 |
...
- **算法协会**：学院为打 ACM 等编程竞赛的同学搭建的交流协作平台，人均~~银金牌~~金牌银牌拿到手软的大佬。
...
- 对竞赛感兴趣的同学可以加入算法协会，从 [OI-Wiki](https://oi-wiki.org/)、[LeetCode](https://leetcode.cn/)、[Codeforces](https://codeforces.com/) 等平台开始练习
- 善用官方文档与搜索引擎，培养自学能力，尽早找到自己感兴趣的方向
- 多写代码、多动手实践，用项目输出倒逼输入
- 一定要及时接触世界前沿的应用技术，哪怕是单纯体验，尤其是明显会导致工作模式变革的AI技术，毕竟本wiki平台的搭建，甚至包括大部分文字信息的整合，均由Agent在2026年7月包干。

## 保研（推免）

计算机科学技术学院的保研工作按照学校统一的 **《青岛大学推荐优秀应届本科毕业生免试攻读研究生工作实施办法》（青大教字〔2021〕21号）** 执行，每年 9 月启动。政策细则（基本条件、综合成绩计算、综合发展素质加分等）见 [考试与成绩 - 保研（推免）](../study/exam.md)。这里结合学院的实际情况，给你说点文件里不会明写、但过来人都在意的东西。
...
- **ACM/算法类竞赛才是计科人的本命赛道**。学院有算法协会，天梯赛、蓝桥杯、ICPC/CCPC 这类"权威竞赛排行榜"上的赛项，拿个省赛国赛奖是能实打实折算进 25% 那一栏的。**但注意：团队赛只有前 3 位算主力队员，赋分依次递减**，所以要么自己当队长拿位次，要么确保自己排进前三。
...
- [DeepSeek](https://chat.deepseek.com/)：推理能力强，写代码、debug 都很能打，尤其token价格，梁圣千古
- [通义千问](https://www.tongyi.com/)：阿里系，功能全面，国际驰名，用它点淘宝闪购外卖再优惠几毛钱
...
- [hermes](https://github.com/nousresearch/hermes-agent):当前比较优质的Agent，推荐使用CLI，当然如果习惯GUI，还是用适合自己的

如果你学了 Python，还可以用 [Ollama](https://ollama.com/) 在本地搭建自己的 AI 模型，既练手又免费，还挺有意思。

> AI 是放大你能力的工具，不是替代你思考的东西。用它加速学习没问题，但基础的知识和代码能力还是要自己扎扎实实练。
...
**再看行业现实**：单纯做开发，一线应届起薪普遍在 30-40W，达到 45W 的多数是算法岗（大模型、NLP、CV 等），而且需要一至两篇相关领域论文 + 一到两家大厂实习背书。本科直接 all in AI 的风险很大——这个方向硕士、博士一抓一大把，成果和学历卡得很死，很多硕士毕业最后还是转了开发岗。
...
- 无论去哪，实习经历都是加分项，大三暑假的实习别错过

![公务员与央国企](../pics/college/college-图1-公务员.png)
